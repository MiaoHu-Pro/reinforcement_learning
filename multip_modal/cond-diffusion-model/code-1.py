...
# generate samples
# images, labels = diffuser.sample(model, labels=torch.tensor([1,8], device=device))
#   File "/local/scratch/mh1f25/python_projects/reinforcement_learning/.venv/lib64/python3.12/site-packages/torch/nn/modules/module.py", line 1778, in _wrapped_call_impl
#     return self._call_impl(*args, **kwargs)
#            ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
#   File "/local/scratch/mh1f25/python_projects/reinforcement_learning/.venv/lib64/python3.12/site-packages/torch/nn/modules/module.py", line 1789, in _call_impl
#     return forward_call(*args, **kwargs)
#            ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
#   File "/local/scratch/mh1f25/python_projects/reinforcement_learning/multip_modal/cond-diffusion-model/code-1.py", line 102, in forward
#     t += self.label_emb(labels)
